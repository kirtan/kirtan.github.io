    ...
    pages = [
      {
        ...
        text: '<span class="smaller"><b>This is a concept.<br>Things will break.</b><br>But it could be cool.</span>'
      }, {
        shapes: [decompose_ck()],
        text: 'NC13 exists<br>as a way for us<br>to come together.'
      }, {
        shapes: [
          clump({
            x: 0.4,
        ...
        text: 'From all corners<br>of the country.<br>And beyond.'
      }, {
        shapes: [
          sharing({
            x: 0.5,
        ...
        text: 'We were paired off<br>into groups.<br>Some of us are now<br>friends forever.'
      }, {
        shapes: [
          infinity({
            x: 0.5,
        ...
        text: 'Our mission: to be ekantik.'
      }, {
        shapes: [
          animated_circle({
            size: 10,
        ...
        text: 'To center our lives around a single goal.'
      }, {
        shapes: [tree()],
        text: 'Something about sharing.'
      }, {
        shapes: [
          clump({
            x: 0.5,
        ...
        text: "Because in this world<br>that's filled with distractions."
      }, {
        shapes: [
          clump({
            x: 0.5,
            ...
            image: './microsite_static/red_dot.png',
            position: {
              x: 0.5,
              y: 0.5
            },
